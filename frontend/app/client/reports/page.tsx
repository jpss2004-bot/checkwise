...
/**
 * Client Reports list — R1.1.
 *
 * Client-executive entry point. Shows the 3 client_facing presets
 * (Resumen ejecutivo mensual, Matriz de riesgo de proveedores,
 * Documentos faltantes por proveedor) plus the client's existing
 * report list. visible_audiences() on the backend restricts both
 * the preset list and the report list to client_facing only — UI
 * hiding is never the protection.
 *
 * The editor still lives at /portal/reports/[id] for now;
 * /client/reports/[id] redirects there until the shared editor lift
 * lands in R1.0.1.
 */
export default function ClientReportsPage() {
  ...
  return (
    <ClientShell
      title="Reportes"
      description="Centro de inteligencia para tu portafolio: estado de cumplimiento, proveedores en riesgo y evidencia documental pendiente."
    >
      {error && (
