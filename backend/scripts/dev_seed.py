...
def main() -> None:
    ...
    print(f"    Roles    internal_admin, reviewer")
    print()
    print(f"  Provider portal:")
    print(f"    URL              http://localhost:3000/")
    print(f"    Use the access form with any client + filial + vendor name.")
    print(f"    Each access call mints a fresh workspace + token.")
    print()
    print(f"  Pre-seeded reviewer workspace (already in the DB):")
