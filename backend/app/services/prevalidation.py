    ...
    *,
    ...
    return [
        ...
        ValidationSignal(
            ...
            message=f"Extensión detectada: {stored_file.extension or 'sin extensión'}.",
        ),
        ValidationSignal(
        ...
        ValidationSignal(
            ...
            result="pending",
            severity="warning",
            message="Pendiente de revisión para confirmar que el archivo satisface el requisito.",
            requires_human_review=True,
        ),
        ValidationSignal(
