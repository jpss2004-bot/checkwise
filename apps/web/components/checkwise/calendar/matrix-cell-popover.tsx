...
export function MatrixCellPopover({
  ...
  // Left-align to the cell (extends rightward) rather than centering: centering
  // made the left-edge month popovers spill over the sticky provider-name
  // column. The viewport clamp in the hook still pulls right-edge cells in.
