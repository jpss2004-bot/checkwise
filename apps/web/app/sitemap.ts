 ...
 * landing page, the login entry and the three legal documents. The
 * authenticated app (portal/client/admin/platform/reports) is omitted
 * deliberately and also disallowed in `app/robots.ts`.
 *
