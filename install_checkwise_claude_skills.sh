...
create_skill "checkwise-ui-designer" "Audits and improves CheckWise as a premium legal-tech/compliance SaaS interface with strong UX, hierarchy, spacing and dashboard clarity." '# CheckWise UI Designer Skill
...
These project-local skills live in `.claude/skills/`.
